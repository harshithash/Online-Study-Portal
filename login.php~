...
<form class="w3-container w3-card-4"  style="float:inline-block;" method="post" action="login.php">
...
if(isset($_POST['login'])){
  ...
  $admin_query="select * from student where stu_id='$stu_name' and stu_pass='$stu_pass' ";
  ...
  {
    $_SESSION['stu_id']=$stu_name;
    echo "<script> window.open('http://localhost/dbms/student/profile.php','_self')  </script>";
  }
  else
  { 
